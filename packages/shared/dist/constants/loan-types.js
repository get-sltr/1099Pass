...
exports.LOAN_TYPES = void 0;
exports.getLoanTypeById = getLoanTypeById;
exports.getAllLoanTypeIds = getAllLoanTypeIds;
...
function getLoanTypeById(id) {
    return exports.LOAN_TYPES.find((lt) => lt.id === id);
}
/** Get all loan type IDs */
function getAllLoanTypeIds() {
    return exports.LOAN_TYPES.map((lt) => lt.id);
}
